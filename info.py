...
API_ID = int(environ.get('API_ID', '25435105'))
API_HASH = environ.get('API_HASH', '011126265844f2d7cc7dc1a024f6bc78')
BOT_TOKEN = environ.get('BOT_TOKEN', "6423934355:AAEKEfTXrnhCNrne6i3gSQBGJX27ONEuqeA")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', ' -1001976740983').split()]
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001947637017')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://BIGBOSS:BIGBOSS@cluster0.ii3gmvr.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001902742096'))
...
FQDN = str(getenv('dmgdog-077c90e6453e.herokuapp.com', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN') else APP_NAME+'.herokuapp.com'
